...
class LLMClient:
    def __init__(self):
        ...
        7. หากพบข้อมูลขัดแย้งกันระหว่างกฎหมายต่างลำดับชั้น ให้ยึดถือลำดับศักดิ์ดังนี้: รัฐธรรมนูญ > พ.ร.บ./พ.ร.ก. > พระราชกฤษฎีกา > กฎกระทรวง > ประกาศ/ระเบียบ
        8. เรียกหน่วยย่อยให้ถูกต้องตามประเภทกฎหมาย: พ.ร.บ. ใช้ 'มาตรา', กฎกระทรวง/ประกาศ/ระเบียบ ใช้ 'ข้อ'
